...
export default function WarehouseSidebar() {
  ...
  return (
    <aside className="w-64 min-h-dvh bg-slate-100 flex flex-col shrink-0">
      {/* Logo */}
      ...
      <div className="px-4 pb-6">
        <button aria-label="Thao tác" type="button" onClick={() => onNavigate('login')} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-slate-200 cursor-pointer transition-colors">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
