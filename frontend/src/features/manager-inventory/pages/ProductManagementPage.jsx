        ...
        {activeTab === 'active' && (
          <div className="flex flex-wrap items-center gap-2">
            {[
              ...
              { key: 'inStock',     label: 'Có hàng',             dot: 'bg-emerald-500', active: 'bg-emerald-600 text-white border-emerald-600',  idle: 'bg-white text-emerald-700 border-emerald-200 hover:border-emerald-400' },
              { key: 'outOfStock',  label: 'Hết hàng',            dot: 'bg-red-500',     active: 'bg-red-600 text-white border-red-600',         idle: 'bg-white text-red-700 border-red-200 hover:border-red-400' },
              { key: 'noVariants',  label: 'Chưa có phiên bản',   dot: 'bg-amber-500',   active: 'bg-amber-500 text-white border-amber-500',     idle: 'bg-white text-amber-700 border-amber-200 hover:border-amber-400' },
            ].map(chip => {
