              ...
              <tr key={log.id} className="hover:bg-gray-50/60 transition-colors group">
                ...
                <td className="px-4 py-4 text-right">
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-semibold text-[#E8420A] hover:text-[#C4350A] px-3 py-1.5 rounded hover:bg-orange-50 cursor-pointer whitespace-nowrap border-none bg-transparent"
                  >
                    Xem phiếu →
                  </button>
                </td>
