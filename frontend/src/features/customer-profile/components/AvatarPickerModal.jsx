...
export default function AvatarPickerModal({ isOpen, onClose, onSelect, currentAvatar }) {
  ...
  const getPredefinedDataUrl = (avatar) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
      <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl border border-gray-100 animate-slide-up">
        ...
        <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          ...
          <button onClick={onClose} className="p-1.5 hover:bg-gray-200 rounded-full text-gray-400 hover:text-gray-600 transition-colors border-none bg-transparent cursor-pointer">
            ...
            <div className="grid grid-cols-3 gap-4">
              {PREDEFINED_AVATARS.map((avatar) => (
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-3.5 rounded-xl border border-gray-200 hover:border-[var(--accent)] hover:bg-orange-50/20 transition-all cursor-pointer bg-white group animate-none"
                >
                  <div
          ...
          <div className="border-t border-gray-100 pt-5">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-2 px-5 py-3 border border-dashed border-gray-300 hover:border-[var(--accent)] text-gray-700 hover:text-[var(--accent)] rounded-xl text-sm font-semibold transition-all cursor-pointer bg-white"
              >
