  ...
  const handleBulkStatusUpdate = async (status) => {
    ...
    if (window.confirm(`Bạn có chắc chắn muốn ${actionText} tài khoản của ${selectedIds.length} khách hàng đã chọn?`)) {
      try {
        ...
        const accountIds = customers.flatMap((c) => selectedSet.has(c.id) && c.accountId ? [c.accountId] : [])
      ...
      <header className="bg-white border-b border-gray-100 px-8 py-3 flex items-center gap-4">
        <div className="flex-1 max-w-sm">
          <div className="relative">
            ...
            <input
              type="text"
              aria-label="Tìm tên, email khách hàng"
              value={search}
      ...
      <div className="flex-1 px-8 py-7 space-y-5">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button aria-label="Thao tác" type="button" className="flex items-center gap-2 bg-[#E8420A] hover:bg-[#C4350A] text-white font-semibold py-2.5 px-4 rounded text-sm transition-colors cursor-pointer">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
              </svg>
              Thêm khách hàng mới
        ...
        <div className="bg-white rounded border border-gray-200 overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-4 px-5 py-4 border-b border-gray-100">
            ...
            <div className="relative min-w-[170px]">
              <select
                aria-label="Lọc theo ngày đăng ký"
                value={joinDateRange}
            ...
            <div className="relative min-w-[180px]">
              <select
                aria-label="Lọc theo mức chi tiêu"
                value={spendFilter}
                  ...
                  return customers.map((customer, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            aria-label={`Chọn khách hàng ${customer.name || customer.id}`}
                            type="checkbox"
                            checked={isSelected}
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full overflow-hidden border border-gray-100 animate-slide-up">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                <label htmlFor="promo-message-input" className="block text-xs font-bold text-gray-500 uppercase tracking-wider">
                  Nội dung khuyến mãi
                </label>
                <textarea
                  id="promo-message-input"
                  aria-label="Nội dung khuyến mãi"
                  value={promoMessage}
