...
function ProductsSection({ items }) { // hiển thị danh sách sản phẩm trong giỏ hàng để kiểm tra
  return (
...
function AddressSection({ addresses, selected, onSelect }) { // hiển thị danh sách địa chỉ nhận hàng của khách hàng để chọn
  return (
...
function PaymentSection({ methods, selected, onSelect }) { // hiển thị danh sách phương thức thanh toán có sẵn để chọn
  return (
...
function OrderSummaryCard({ summary, onOrderSubmit, submitting }) { // hiển thị tóm tắt thông tin hóa đơn tổng tiền
