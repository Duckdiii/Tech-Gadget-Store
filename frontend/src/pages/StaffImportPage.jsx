...
const PRODUCTS = [
  { id:1, name:'iPhone 15 Pro Max 256GB',   sku:'APL-IP15PM-256',  unit:'Cái', price:29990000 },
  { id:2, name:'Samsung Galaxy S24 Ultra',   sku:'SAM-S24U-256',   unit:'Cái', price:27990000 },
  { id:3, name:'MacBook Air M3 13"',         sku:'APL-MBA-M3-13',  unit:'Cái', price:29990000 },
  { id:4, name:'AirPods Pro 2nd Gen',        sku:'APL-APP2',       unit:'Cái', price:5990000  },
  { id:5, name:'iPad Pro 11" M4',            sku:'APL-IPDPRO-M4',  unit:'Cái', price:23990000 },
  { id:6, name:'Samsung 65" QLED TV',        sku:'SAM-TV65Q',      unit:'Cái', price:22990000 },
  { id:7, name:'Sony WH-1000XM5',            sku:'SON-WH1000XM5',  unit:'Cái', price:7990000  },
  { id:8, name:'Apple Watch Series 9 45mm',  sku:'APL-AW9-45',     unit:'Cái', price:10990000 },
]
...
function genId() {
  ...
  return `PN-${s}-${String(Math.floor(Math.random()*900)+100)}`
}
...
const BLANK_ROW = () => ({ productId:'', qty:1, unitPrice:0 })
...
export default function StaffImportPage() {
  ...
  function handleSubmit() {
    ...
    setErrors({})
    setReceipt({ id:genId(), date, supplier, warehouse, note, rows: validRows })
  }
                ...
                return (
                  <div key={i} className="px-6 py-4 flex items-center gap-3">
                    ...
                    <div className="w-32 text-right shrink-0">
                      <p className="text-sm font-bold text-gray-800">{fmt((Number(row.qty)||0) * (Number(row.unitPrice)||0))}đ</p>
                      {p && <p className="text-[11px] text-gray-400">{p.unit}</p>}
                    </div>
