...
import com.project.tech_gadget_store.modules.warehouse.dto.response.SupplyOrderItemResponseDto;
...
public class SupplyOrderMapper {
    ...
    private SupplyOrderItemResponseDto toItemResponseDto(SupplyOrderItem item) {
        return SupplyOrderItemResponseDto.builder()
                ...
                .productName(item.getProduct().getProduct().getName())
                .variantLabel(item.getProduct().getDisplayName())
