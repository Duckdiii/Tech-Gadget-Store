...
class ExportLogServiceTest {
        ...
        void exportProducts_Success_ProductOutOfStock_SendsNotifications() {
                ...
                verify(receiptRepository).save(any(Receipt.class));
                verify(eventPublisher, atLeastOnce()).publishEvent(any(com.project.tech_gadget_store.modules.notification.event.ExportStockEvent.class));
                verify(eventPublisher, atLeastOnce()).publishEvent(any(com.project.tech_gadget_store.modules.notification.event.ProductStockChangedEvent.class));
        }
        ...
        void exportProducts_ReceiptGenerationFails_SavesExportButReturnsWarningMessage() {
                ...
                when(exportLogMapper.toExportLogResponseDto(any(ExportLog.class), isNull(),
                                eq("Products were exported, but the receipt could not be generated")))
                                .thenReturn(ExportLogResponseDto.builder()
                                                .id("export-log-id")
                                                .performedById("performer-id")
                                                .receiptId(null)
        ...
        void exportProducts_RetrieveInventoryFails_ReturnsRetrieveWarning() {
                ...
                when(exportLogMapper.toExportLogResponseDto(any(ExportLog.class), eq("receipt-id"),
                                eq("Unable to retrieve inventory status")))
                                .thenReturn(ExportLogResponseDto.builder()
                                                .id("export-log-id")
                                                .performedById("performer-id")
                                                .receiptId("receipt-id")
        ...
        void exportProducts_RecordInventoryChangeFails_ReturnsRecordWarning() {
                ...
                // Mock Mapper to expect warning message
                when(exportLogMapper.toExportLogResponseDto(any(ExportLog.class), eq("receipt-id"),
                                eq("Unable to record inventory change status")))
                                .thenReturn(ExportLogResponseDto.builder()
                                                .id("export-log-id")
                                                .performedById("performer-id")
                                                .receiptId("receipt-id")
